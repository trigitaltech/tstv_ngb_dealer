  ...
  data() {
    ...
    json_data: [],
      ...
      items: [
        ...
        {
          text: 'Reports / Customer Activation Reports',
          active: true,
        },
      ],
      totalRows: 1,
    ...
    //    },
      fields: [
        {label:'Account NO', key: '0', sortable: true },
        {label:'Serial NO', key: '1',  sortable: true },
        { label:'Display Name', key: '2', sortable: true },
        {label:'Email', key: '3', sortable: true },
         {label:'Phone',  key: '4', sortable: true },
          {label:'Activation date', key: '5', sortable: true },
  ...
  <Layout>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-12">
       <b-card
            class="card-wrap"
            header="Customer Activation Reports"
            border-variant="info"
